...
<html lang="en">
  ...
  <nav class="navbar navbar-light sticky-top mb-5" style="background-color: #3289c8;">
    ...
    <a class="fw-bold" style="color: white; text-decoration: none; margin-left: -790px; font-size:x-large;">Form Edit Profile</a>
    </div>
</nav>
...
<!-- Form Edit -->
  ...
  <button id="btn" class="btn mt-3 mb-3 btn-outline-primary" style="width: 17%; margin-left: 900px" name="editp" value="edit">Simpan Perubahan</button>
